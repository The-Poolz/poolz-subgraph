...
export const SIMPLE_BUILDER_ADDRESS = Bytes.fromHexString("0x4c6842E242B39F16328f2dEEd8cF23b407982aff")
export const SIMPLE_REFUND_BUILDER_ADDRESS = Bytes.fromHexString("0x906f2db10cac66cd31859656a2d198ecae7b9ef1")
export const DISPENSER_ADDRESS = Bytes.fromHexString("0x93441BF11A3Cc2352253013990d68F5A2b1EC3ed")
